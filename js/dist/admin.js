...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('flagrow-guardian', function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_PermissionGrid__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'startItems', function (items) {
    items.add('actWithoutFootprint', {
      ...
      label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('flagrow-guardian.admin.permissions.act_without_footprint'),
      permission: 'actWithoutFootprint',
      allowGuest: true
    }, 5);
    items.add('actWithoutFlooding', {
      icon: 'fas fa-shipping-fast',
      label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('flagrow-guardian.admin.permissions.act_without_floodgate'),
